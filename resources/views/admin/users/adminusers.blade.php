        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h4 class="page-title"> المديرون</h4>
                    <ol class="breadcrumb">
                        <li>
                            <a href="#">المستخدمين</a>
                        </li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box table-responsive">
                        <div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                 <form class="add_form" go="{{ url('/adminusers/addusers') }}"  >
                        ...
                        <br>
                        <br>
                           <form action="#" id="action_form" method="post"  go="{{ url('adminusers/deleteselected') }}">

                            {{ csrf_field() }}
                        <table id="datatable-responsive" class="adminusers table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                <th>
...
<script type="text/javascript">
      $('.adminusers').dataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "{{ url('adminusers/adminusersdatatable') }}",
        "columns": [
