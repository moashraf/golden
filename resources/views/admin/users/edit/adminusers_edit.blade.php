<form class="edit_form" go='{{ url("/adminusers/updateusers/$user->id") }}'  >
                                          ...
                                          <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                   ...
                                                   <textarea class="form-control autogrow" id="field-7" name="address" placeholder="وصف المنتج" style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 104px;">{{$user->address}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
